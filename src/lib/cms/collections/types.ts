...
export type CmsCollectionEditor = CmsCollectionSummary & { content: ManagedContent; seo: ManagedSeo; revisions: CmsCollectionRevision[]; categories: { id: string; key: string; name: string }[]; parents: { id: string; title: string; type: ManagedContentType; country: string | null }[] };
