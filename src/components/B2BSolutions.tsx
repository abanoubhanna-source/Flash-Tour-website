      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <motion.div 
            ...
            viewport={{ once: true }} 
            className="bg-white p-10 rounded-[2rem] border border-slate-200 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group"
          >
            ...
            <h3 className="text-2xl font-bold text-[#0F162A] font-en mb-4">DMC & Inbound</h3>
            <p className="text-slate-600 font-en leading-relaxed mb-8">
              Comprehensive ground handling, hotel contracting, and exclusive excursion management in Egypt, UAE, Italy, and Zanzibar.
            </p>
          ...
          {/* Card 2: MICE (Highlighted / Center) */}
          <motion.div 
            initial={{ opacity: 0, y: 30 }} 
            whileInView={{ opacity: 1, y: 0 }} 
            viewport={{ once: true }} 
            transition={{ delay: 0.1 }} 
            className="bg-[#157670] p-10 rounded-[2rem] shadow-2xl hover:-translate-y-2 transition-all duration-300 group relative overflow-hidden"
          >
            {/* Pattern Overlay for the highlighted card */}
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-2xl font-bold text-white font-en mb-4">MICE Management</h3>
              <p className="text-white/90 font-en leading-relaxed mb-8">
                Flawless execution of international conferences, high-end incentive trips, and large-scale corporate events up to 5,000+ delegates.
              </p>
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-[#0F162A] font-en mb-4">Fleet & Mobility</h3>
            <p className="text-slate-600 font-en leading-relaxed mb-8">
              Direct access to our owned fleet of luxury sedans, 4x4s, and VIP coaches, ensuring uncompromised safety and competitive corporate rates.
            </p>
            <Link href="/services" className="text-[#157670] font-bold font-en flex items-center gap-2 group-hover:translate-x-2 transition-transform">
