...
const defaultTropicalData: HospitalityShowcaseItem[] = [
  ...
  { id: '04', name: 'Tropical Corporate Retreats', tag: 'MICE & INCENTIVES', desc: 'Elevate your corporate events in a breathtaking tropical setting. We offer tailored B2B solutions for incentive groups, combining professional environments with unforgettable leisure activities and VIP mobility.', img: '/images/zanzibar-corporate.jpg', icon: Briefcase, specs: ['Tailored B2B Solutions', 'Incentive Travel', 'Team Building Events', 'VIP Ground Mobility'] },
];
