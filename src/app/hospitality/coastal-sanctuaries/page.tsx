...
const defaultCoastalData: HospitalityShowcaseItem[] = [
  ...
  { id: '03', name: 'Exquisite Private Beaches', tag: 'PRISTINE COASTLINES', desc: 'Unwind on golden sands merging seamlessly with the deep blue. Our private beaches offer unmatched tranquility, luxury cabanas, and elite beachside service for the most discerning guests.', img: '/images/private-beach.jpg', icon: Sun, specs: ['Luxury Cabanas', 'Beachside Dining', 'Exclusive Access', 'Crystal Clear Waters'] },
  { id: '04', name: 'World-Class Spa & Kitesurfing Hub', tag: 'WELLNESS & ADVENTURE', desc: 'Balance ultimate relaxation with thrilling adventure. Rejuvenate your senses at our holistic world-class spa, or ride the wind at our professional Tulipe Kitesurfing Hub.', img: '/images/kitesurfing-spa.jpg', icon: Wind, specs: ['Holistic Spa Treatments', 'Professional Kitesurfing', 'Wellness Therapies', 'Extreme Sports'] },
];
